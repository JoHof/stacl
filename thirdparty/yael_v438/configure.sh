...
cflags="-fPIC -Wall -g -O3 $CFLAGS  -fopenmp"
ldflags="-g -fPIC $LDFLAGS -fopenmp"
...
if [ -e /usr/lib/libblas.so.3gf ]; then
   ...
   lapackldflags="/usr/lib/x86_64-linux-gnu/libblas.so.3gf /usr/lib/x86_64-linux-gnu/liblapack.so.3"

elif [ -e /usr/lib/x86_64-linux-gnu/atlas/libblas.so.3 ]; then 
   lapackldflags="/usr/lib/x86_64-linux-gnu/atlas/libblas.so.3 /usr/lib/x86_64-linux-gnu/atlas/liblapack.so.3"
elif [ -e /usr/lib/x86_64-linux-gnu/atlas/libf77blas.so.3 ]; then 
   lapackldflags="/usr/lib/x86_64-linux-gnu/atlas/libf77blas.so.3 /usr/lib/x86_64-linux-gnu/atlas/liblapack.so.3"
elif [ -e /usr/lib/x86_64-linux-gnu/libblas.so.3 ]; then 
   lapackldflags="/usr/lib/x86_64-linux-gnu/libblas.so.3 /usr/lib/x86_64-linux-gnu/liblapack.so.3"
elif [ -e /usr/lib/x86_64-linux-gnu/atlas/libblas.so.3 ]; then
   lapackldflags="/usr/lib/x86_64-linux-gnu/atlas/libblas.so.3 /usr/lib/atlas/liblapack.so.3"
else
...
usearpack=yes
arpackldflags=/usr/lib/x86_64-linux-gnu/libarpack.so.2
